  ...
  content = <<-DOC
    ...
    Prephost:
      hosts:
        ...
        db01:
          ansible_ssh_common_args: "-o StrictHostKeyChecking=no -J ubuntu@${yandex_compute_instance.proxy.network_interface.0.nat_ip_address}"
        db02:
          ansible_ssh_common_args: "-o StrictHostKeyChecking=no -J ubuntu@${yandex_compute_instance.proxy.network_interface.0.nat_ip_address}"
        app:
          ansible_ssh_common_args: "-o StrictHostKeyChecking=no -J ubuntu@${yandex_compute_instance.proxy.network_interface.0.nat_ip_address}"
      ...
      vars:
        ...
        ip_nginx: ${yandex_compute_instance.proxy.network_interface.0.ip_address}
